            ...
            <div className="flex flex-col lg:flex-row justify-center h-full items-center px-12 md:px-24 lg:px-48 gap-4 lg:gap-12 p-4">
              <div className="w-fit pt-6">
                <p className="text-sm lg:text-2xl leading-relaxed">
                  In a pivotal online event, &quot;The Women Story&quot; NGO
                  hosted an enlightening session on &apos;Cyber Bullying and its
                  Consequences on Mental Health,&apos; led by Dr. Madhoolika
                  Sahu. This impactful session educated participants on critical
                  issues, promoting mental well-being and fostering a safer
                  digital environment for our community.
                </p>
              </div>
              <div className="w-fit">
                <Image
